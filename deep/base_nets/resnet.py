...
def resnet(input_image, architecture, stage5=False, train_bn=True):
    ...
    temp_model = Model(inputs=input_image, outputs=x)
...
if __name__ == '__main__':
    ...
    out = resnet(input_image=nn_input, architecture='resnet50', stage5=False, train_bn=True)
    model = Model(inputs=nn_input, outputs=out)
    print(model.summary())